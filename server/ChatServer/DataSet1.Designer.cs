...
namespace ChatServer {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationMessages_Users;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationMessages_Users = this.Relations["Messages_Users"];
        }
        ...
        private void InitClass() {
            ...
            this.relationMessages_Users = new global::System.Data.DataRelation("Messages_Users", new global::System.Data.DataColumn[] {
                        this.tableMessages.loginColumn}, new global::System.Data.DataColumn[] {
                        this.tableUsers.IdColumn}, false);
            this.Relations.Add(this.relationMessages_Users);
        }
        ...
        public partial class MessagesDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MessagesRow AddMessagesRow(int Id, int login, string message) {
        ...
        public partial class UsersDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(MessagesRow parentMessagesRowByMessages_Users, string login, string password, int access) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        password,
                        access};
                if ((parentMessagesRowByMessages_Users != null)) {
                    columnValuesArray[0] = parentMessagesRowByMessages_Users[1];
                }
        ...
        public partial class MessagesRow : global::System.Data.DataRow {
            ...
            public int login {
                get {
                    return ((int)(this[this.tableMessages.loginColumn]));
                }
                set {
                    this[this.tableMessages.loginColumn] = value;
                }
            }
            ...
            public UsersRow[] GetUsersRows() {
                if ((this.Table.ChildRelations["Messages_Users"] == null)) {
                    return new UsersRow[0];
                }
                else {
                    return ((UsersRow[])(base.GetChildRows(this.Table.ChildRelations["Messages_Users"])));
                }
            }
        }
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public MessagesRow MessagesRow {
                get {
                    return ((MessagesRow)(this.GetParentRow(this.Table.ParentRelations["Messages_Users"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Messages_Users"]);
                }
            }
        }
...
namespace ChatServer.DataSet1TableAdapters {
    ...
    public partial class MessagesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Messages] WHERE (([Id] = @Original_Id) AND ([login] = @Origina" +
                "l_login) AND ([message] = @Original_message))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Messages] ([Id], [login], [message]) VALUES (@Id, @login, @mes" +
                "sage);\r\nSELECT Id, login, message FROM Messages WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Messages] SET [Id] = @Id, [login] = @login, [message] = @message WH" +
                "ERE (([Id] = @Original_Id) AND ([login] = @Original_login) AND ([message] = @Ori" +
                "ginal_message));\r\nSELECT Id, login, message FROM Messages WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ChatServer.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, login, message FROM dbo.Messages";
        ...
        public virtual int Delete(int Original_Id, int Original_login, string Original_message) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_login));
        ...
        public virtual int Insert(int Id, int login, string message) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(login));
            if ((message == null)) {
        ...
        public virtual int Update(int Id, int login, string message, int Original_Id, int Original_login, string Original_message) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(login));
            if ((message == null)) {
                throw new global::System.ArgumentNullException("message");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int login, string message, int Original_Id, int Original_login, string Original_message) {
            return this.Update(Original_Id, login, message, Original_Id, Original_login, Original_message);
        }
    }
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([login] = @Original_l" +
                "ogin) AND ([password] = @Original_password) AND ([access] = @Original_access))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Id], [login], [password], [access]) VALUES (@Id, @log" +
                "in, @password, @access);\r\nSELECT Id, login, password, access FROM Users WHERE (I" +
                "d = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [login] = @login, [password] = @password, [access] = @access WHERE (([Id] = @Original_Id) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ([access] = @Original_access));
SELECT Id, login, password, access FROM Users WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, login, password, access FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_login, string Original_password, int Original_access) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string login, string password, int access) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((login == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(access));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string login, string password, int access, int Original_Id, string Original_login, string Original_password, int Original_access) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((login == null)) {
                throw new global::System.ArgumentNullException("login");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(access));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, int access, int Original_Id, string Original_login, string Original_password, int Original_access) {
            return this.Update(Original_Id, login, password, access, Original_Id, Original_login, Original_password, Original_access);
        }
    }
